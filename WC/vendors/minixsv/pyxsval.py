...
import string
import vendors.genxmlif
from vendors.minixsv           import *
...
def _interfaceFactoryMinidom (verbose, useCaching, processXInclude):
    return vendors.genxmlif.chooseXmlIf(vendors.genxmlif.XMLIF_MINIDOM, verbose, useCaching, processXInclude)

def _interfaceFactory4Dom (verbose, useCaching, processXInclude):
    return vendors.genxmlif.chooseXmlIf(vendors.genxmlif.XMLIF_4DOM, verbose, useCaching, processXInclude)

def _interfaceFactoryElementTree (verbose, useCaching, processXInclude):
    return vendors.genxmlif.chooseXmlIf(vendors.genxmlif.XMLIF_ELEMENTTREE, verbose, useCaching, processXInclude)
